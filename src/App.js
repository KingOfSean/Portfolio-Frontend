				...
				<div className="nav-container">
							...
							<>
								{enter ? null : (
									<h1 className="front-header">
										Sean King's Portfolio WebPage
									</h1>
								)}
							</>
							<img
								className={enter ? "logo-enter" : "logo"}
								src="https://i.imgur.com/sflbz7o.png"
								alt=""
							/>
							<>
								{enter ? null : (
					...
					<div className="nav-links">
						<div>
							<>
								{showHome ? (
									<Link className="home" onClick={hideHome} to="/">
										<RiHome4Fill style={style} />
										Home
									</Link>
								) : null}
							</>
						...
						<div>
							<Link className="about" onClick={revealHome} to="/about">
								<IoMdPerson style={style} />
								About
							</Link>
						</div>
						<div>
							<Link className="projects" onClick={revealHome} to="/projects">
								<IoIosFolder style={style} />
								Projects
							</Link>
						</div>
						<div>
							<Link className="contacts" onClick={revealHome} to="/contacts">
								<IoMdContact style={style} />
								Contact
							</Link>
						</div>
						<div>
							<Link className="admin" onClick={revealHome} to="/admin">
